...
def start():
    ...
    warrior = Warrior("Soup", randint(250, 300), 10)
    medic_1 = Medic("Doc", randint(220, 240), 5, 15)
    medic_2 = Medic("Pavel", randint(270, 300), 10, 5)
    ...
    avrora = Avrora("Kobra", randint(230, 300), 15)
    hacker = Hacker("Alex", randint(220, 300), 20)
    tricky = TrickyBastard("Fox", randint(230, 3100), 15)
    antMan = AntMan("BRIAN", randint(250, 350), 20)
